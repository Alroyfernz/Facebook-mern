...
const Homeheader = ({ selected }) => {
  ...
  const collapseInput = () => {
    ...
    if (x.matches) {
      document.getElementsByClassName("mobileHeader")[0].style.display =
        "block";
    } else {
  ...
  return (
    <div className="homeHeader">
      <div className="homeHeaderLogoAndSearch">
        ...
        <div className="homeHeader__searchBack" onClick={collapseInput}>
          <BiArrowBack className="searchIcon" />
        </div>
        <div className="homeHeader__search" onClick={expandInput}>
          <BsSearch className="searchBackIcon" />
        </div>
        <input
          type="text"
      ...
      <div className="homeHeader__pages">
        <div className="home">
          {selected ? (
            <Link to="/">
              <svg
                viewBox="0 0 28 28"
                className={`PagesIcon ${selected && "selected"}`}
                height="28"
                width="28"
              >
        ...
        <div className="friends">
          <svg viewBox="0 0 28 28" className="PagesIcon" height="28" width="28">
      ...
      >
        ...
        >
          <BsGrid3X3Gap className="addIcon" style={{ margin: "unset" }} />
        </div>
